...
set.laststatus      = 3                                 -- Set statusline
...
set.scrolloff       = 5                                 -- When scrolling, keep cursor 5 lines away from border screen
...
set.foldenable      = false                             -- No Fold
set.completeopt     = "menu,menuone,noselect,noinsert"  -- Better auto complete menu
...
cmd([[
    if has("autocmd")
        au BufWritePost * silent :mks! ~/.cache/nvim/Session.vim
    endif
]])
